...
public class OperateGUI {
	...
	private void initialize() {
		...
		JMenu mnNewMenu = new JMenu("新建联系人");
		...
		JMenuItem mntmNewMenuItem = new JMenuItem("查看账户信息");
