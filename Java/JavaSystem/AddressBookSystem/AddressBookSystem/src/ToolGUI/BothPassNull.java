...
public class BothPassNull extends JDialog {
	...
	/*public static void main(String[] args) {
		try {
			PassNullGUI dialog = new PassNullGUI();
	...
	public BothPassNull() {
		...
		contentPanel.setLayout(null);
		{
			...
			textArea.setBounds(85, 28, 230, 42);
			textArea.setText("输入或确认密码栏不能为空！\r\n请确认后重试！");
			textArea.setColumns(10);
			contentPanel.add(textArea);
		}
		{
			JLabel label = new JLabel("");
			label.setIcon(new ImageIcon("D:\\编程\\Java\\Java\\JavaSystem\\AddressBookSystem\\素材\\感叹号1.jpg"));
			label.setBounds(25, 10, 50, 77);
